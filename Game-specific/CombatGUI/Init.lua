...
if game.GameId == 3808081382 then
    ...
    if not ok then
        loadstring(game:HttpGet("https://raw.githubusercontent.com/JustSomeGuest/Scripts/main/Game-specific/CombatGUI/Script.lua"))()
    end
else
    Notify("CombatGUI+ only supports The Strongest Battlegrounds")
end
