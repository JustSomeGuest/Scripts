...
local success, err = pcall(function()
    ...
    ToggleBtn.Position = UDim2.new(0, 20, 0, 4)
    ...
    local PreviousBtn = Instance.new("ImageButton")
    PreviousBtn.Name = "Previous"
    PreviousBtn.BorderSizePixel = 0
    PreviousBtn.BackgroundTransparency = 1
    PreviousBtn.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    PreviousBtn.Image = "rbxassetid://12008863261"
    PreviousBtn.Size = UDim2.new(0.15833, 0, 0.25, 0)
    PreviousBtn.BorderColor3 = Color3.fromRGB(0, 0, 0)
    PreviousBtn.Rotation = -180
    PreviousBtn.Position = UDim2.new(0.19167, 0, 0.53947, 0)
    PreviousBtn.Parent = MainFrame

    local PreviousRatio = Instance.new("UIAspectRatioConstraint")
    PreviousRatio.Parent = PreviousBtn
    ...
    NextBtn.Image = "rbxassetid://12008863261"
    NextBtn.Size = UDim2.new(0.15833, 0, 0.25, 0)
    NextBtn.BorderColor3 = Color3.fromRGB(0, 0, 0)
    NextBtn.Position = UDim2.new(0.66944, 0, 0.53947, 0)
    NextBtn.Parent = MainFrame

    local NextRatio = Instance.new("UIAspectRatioConstraint")
    NextRatio.Parent = NextBtn
    ...
    local LoopBtn = Instance.new("ImageButton")
    LoopBtn.Name = "Loop"
    LoopBtn.BorderSizePixel = 0
    LoopBtn.BackgroundTransparency = 1
    LoopBtn.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    LoopBtn.Image = "rbxassetid://127077202039990"
    LoopBtn.Size = UDim2.new(0, 24, 0, 24)
    LoopBtn.BorderColor3 = Color3.fromRGB(0, 0, 0)
    LoopBtn.Position = UDim2.new(0.01201, 0, 0.84242, 0)
    ...
    PauseBtn.Image = "rbxassetid://12099513379"
    PauseBtn.Size = UDim2.new(0.15833, 0, 0.25, 0)
    PauseBtn.BorderColor3 = Color3.fromRGB(0, 0, 0)
    PauseBtn.Position = UDim2.new(0.41944, 0, 0.53947, 0)
    PauseBtn.Parent = MainFrame

    local PauseRatio = Instance.new("UIAspectRatioConstraint")
    PauseRatio.Parent = PauseBtn
    ...
    SettingsBtn.Image = "rbxassetid://9405931578"
    SettingsBtn.Size = UDim2.new(0, 24, 0, 24)
    SettingsBtn.BorderColor3 = Color3.fromRGB(0, 0, 0)
    SettingsBtn.Position = UDim2.new(0, 256, 0.84, 0)
    ...
    TitleSizeConstraint.MaxSize = Vector2.new(math.huge, 28)
    ...
    local VolumeSizeConstraint = Instance.new("UISizeConstraint")
    VolumeSizeConstraint.MinSize = Vector2.new(10, 0)
    VolumeSizeConstraint.Parent = VolumeBox
    ...
    local SpeedSizeConstraint = Instance.new("UISizeConstraint")
    SpeedSizeConstraint.MinSize = Vector2.new(10, 0)
    SpeedSizeConstraint.Parent = SpeedBox
    ...
    local defaultLoopColor = LoopBtn.ImageColor3
    ...
    LoopBtn.ImageColor3 = isLooping and loopisLoadedColor or defaultLoopColor
    ...
    local function PlaySong(index)
        ...
        isPaused = false
        PauseBtn.Image = defaultPauseImage
    ...
    SettingsBtn.MouseButton1Click:Connect(function()
        ...
        if SettingsFrame.Visible then
            SettingsBtn.ImageColor3 = loopisLoadedColor
        else
...
if not success then
    warn("SoundDock Error: "..tostring(err))
    pcall(function()
        Services.StarterGui:SetCore("SendNotification", {
            Title = "SoundDock Error",
